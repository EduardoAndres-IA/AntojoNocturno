...
export default function CartDrawer() {
  ...
  const pay = () => {
    alert(
      "🔧 Modo de prueba: aquí se abrirá el pago de Mercado Pago cuando lo conectemos.",
    );
  };
    ...
    <>
      ...
      >
        <div className="flex items-center justify-between border-b border-cream/10 px-6 py-5">
          <h3 className="font-display text-[1.35rem] font-semibold">Mi pedido</h3>
          <button
            onClick={closeCart}
            aria-label="Cerrar"
          ...
          {count === 0 ? (
            ...
            Object.entries(cart).map(([id, q]) => {
              ...
              return (
                <div
                  key={id}
                  className="flex gap-3 border-b border-cream/10 py-4"
                >
